...
:::duck
**Did you know?** You can easily create custom character chats for your blog with The CoolStuff Blog!
:::
```
...
To add your own character, first add an image file to the top-level `/public` directory in your cloned The CoolStuff Blog repo. Astro cannot automatically optimize image assets from markdown plugins, so make sure to compress the image to a web-friendly size (<100kb).
...
::github{repo="aaditagrawal/aaditagrawal"}
```
